class Api::ExpensesController < ApplicationController
  def index
    ...
    #added date: :desc in order to show the latest expense by date and if same date it will order to the latest created_at
    ...
    if params[:year].present? && params[:month].present?
      ...
      #changed the where filtering created_at to date because we want to filter by the date of the expense, not when it was created in the database
